...
urlpatterns = [
                  ...
                  path('elevated/utilities/reading/<int:pk>/edit/', views.utility_reading_edit,
                       name='utility_reading_edit'),
                  path('elevated/utilities/reading/<int:pk>/delete/', views.utility_reading_delete,
                       name='utility_reading_delete'),
                  path('elevated/utilities/manage/', views.utilities_manage, name='utilities_manage'),
                  path('elevated/utilities/opening-lookup/', views.utility_opening_lookup,
                       name='utility_opening_lookup'),

                  path('elevated/remittance/', views.remittance_list, name='remittance_list'),
                  path('elevated/remittance/<int:pk>/add-payment/', views.remittance_add_payment,
                       name='remittance_add_payment'),
                  path('elevated/remittance/payment/<int:pk>/edit/', views.remittance_edit_payment,
                       name='remittance_edit_payment'),
                  path('elevated/remittance/<int:pk>/prefill/', views.remittance_apply_suggestion,
                       name='remittance_apply_suggestion'),
                  path('elevated/remittance/setup/', views.remittance_setup, name='remittance_setup'),
                  path('elevated/remittance/report/', views.remittance_report, name='remittance_report'),
                  path('elevated/remittance/report/export/excel/', views.remittance_report_excel,
                       name='remittance_report_excel'),
                  path('elevated/remittance/report/export/pdf/', views.remittance_report_pdf,
                       name='remittance_report_pdf'),
